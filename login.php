              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" method="POST" novalidate>
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        ...
                        <input type="email" name="username" class="form-control" id="yourUsername" autocomplete="Off" required>
                    ...
                    <div class="col-12">
                      ...
                      <input type="password" name="password" class="form-control" id="yourPassword" autocomplete="Off" srequired>
                  ...
                  if(isset($_POST['submit'])){ 
                    ...
                    $select=mysqli_query($conn, "SELECT * FROM tree_feller WHERE username='$username' AND password='$password' ");
